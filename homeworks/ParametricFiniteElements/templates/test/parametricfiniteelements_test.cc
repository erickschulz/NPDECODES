...
TEST(ParametricFiniteElements, assembleGeoTherm) {
  ...
  auto Psi = [] (double x1) -> double {
	  return x1 * x1 + 1.0;
  };

  std::vector<Eigen::Triplet<double>> triplets = ParametricFiniteElements::assembleGeoTherm(n, alpha, Psi);
  ...
  A_ref << 1.61719, -0.84375, 0, -0.867188, 0.09375, 0, 0, 0, 0, 
  		   -0.84375, 3.45, -1.21875, -0.09375, -1.575, 0.28125, 0, 0, 0,
		   0, -1.21875, 1.69922, 0, -0.28125, -0.199219, 0, 0, 0,
		   -0.867188, -0.09375, 0, 3.32812, -1.6875, 0, -0.960938, 0.28125, 0,
		   0.09375, -1.575, -0.28125, -1.6875, 7.65, -2.4375, -0.28125, -2.325, 0.84375, 
		   0, 0.28125, -0.199219, 0, -2.4375, 3.82031, 0, -0.84375, -0.621094, 
		   0, 0, 0, -0.960938, -0.28125, 0, 2.36545, -0.84375, 0,
		   0, 0, 0, 0.28125, -2.325, -0.84375, -0.84375, 5.6802, -1.21875, 
		   0, 0, 0, 0, 0.84375, -0.621094, 0, -1.21875, 1.44679; 
...
TEST(ParametricFiniteElements, geoThermSolve) {
  ...
  mu_ref << 1, 1, 1, 1, 
  			0.860946, 0.845351, 0.79932, 0.724646, 
			0.722159, 0.690899, 0.601355, 0.460807, 
			0.584267, 0.537488, 0.411906, 0.220445;
