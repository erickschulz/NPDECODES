/**
 * @file engquistoshernumericalflux_test_mysolution.cc
...
TEST(EngquistOsherNumericalFlux, EngquistOsherNumFlux) {
  ...
  Eigen::Vector4d flux_ref = {1.54308063481524, 1.0, 3.76219569108363, 2.480035580449628};
  Eigen::Vector4d flux;
...
TEST(EngquistOsherNumericalFlux, solveCP) {
  ...
  ufinal_ref << 0.0, 0.096997499166518, 0.190962447462037, 0.284836944894129, 0.215163055105871, 0.109037552537963;
