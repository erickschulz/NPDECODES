...
int main(){
  ...
  //initial conditions:
  //const auto u0 = [](const Eigen::Vector2d& x){ return 1-(x(0)* x(0) + x(1)*x(1));};
  ...
  //OUTPUT RESULTS
  //construct writers
  lf::io::VtkWriter vtk_writer_rot_1(mesh_p, CURRENT_BINARY_DIR
                      "/transp_semi_lagr_solution/rot_1.vtk");
  lf::io::VtkWriter vtk_writer_rot_10(mesh_p, CURRENT_BINARY_DIR
                      "/transp_semi_lagr_solution/rot_10.vtk");  
  lf::io::VtkWriter vtk_writer_trp_1(mesh_p, CURRENT_BINARY_DIR
                      "/transp_semi_lagr_solution/trp_1.vtk");
  lf::io::VtkWriter vtk_writer_trp_10(mesh_p, CURRENT_BINARY_DIR
                      "/transp_semi_lagr_solution/trp_10.vtk");  
