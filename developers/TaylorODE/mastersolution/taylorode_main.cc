...
//! \file taylorprey.cpp Problem 3, solving prey/predator model with taylor
//! expansion method
...
int main() {
  ...
  struct odefun {
    ...
    std::function<Eigen::VectorXd(const Eigen::VectorXd &,
        ...
        df = [this](const Eigen::VectorXd &y, const Eigen::VectorXd &z) {
    ...
    std::function<Eigen::VectorXd(const Eigen::VectorXd &,
                                  const Eigen::VectorXd &)>
        d2f = [this](const Eigen::VectorXd &y, const Eigen::VectorXd &z) {
  ...
  double beta1 = 0.1;
  double beta2 = 0.1;
  // TODO: implement a structure for the evaluation of $f$, $df$ and $d2f$
